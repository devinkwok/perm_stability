...
class TestInitializations(BaseTest):
    ...
    def test_normalize_weights(self):
        ...
        std = 2
        mean = -1
        normalized = nn_normalize_weights(self.ckpt_init, std_mean=(std, mean))
        ...
        normalized = nn_normalize_weights(self.ckpt_init, std_mean=std_mean)
        ...
        normalized = nn_normalize_weights(self.ckpt_init)
